...
#SBATCH --workdir=/chome/cluser/job_results/openfoam/openfoam/13/omp-sys/2014-11-16_11-43-36
...
sed -i -e "s/numberOfSubdomains.*/numberOfSubdomains ${SLURM_NPROCS};/" /chome/cluser/job_results/openfoam/openfoam/13/omp-sys/2014-11-16_11-43-36/system/decomposeParDict
...
sed -i -e "s/SED_DECOMP/(${SED_DECOMP})/" /chome/cluser/job_results/openfoam/openfoam/13/omp-sys/2014-11-16_11-43-36/system/decomposeParDict
