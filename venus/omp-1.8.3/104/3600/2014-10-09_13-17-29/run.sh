...
#SBATCH --workdir=/chome/cluser/job_results/venus/omp-1.8.3/104/3600/2014-10-09_13-17-29
...
mpirun --mca btl "openib,sm,self"  /chome/cluser/hpcg-2.4/${OS_BASE}${OS_VER}_${MPI_VER}/bin/xhpcg
EC=$?
